...
const Create = () => {
  ...
  return (
    <div className="bg-white h-screen text-black">
      ...
      <div className="border-solid border border-gray-300 rounded mx-40 my-2">
        <div className="form-control">
          <div className="input-group mt-5 ml-5">
            <button
              className="btn btn-square bg-cyan-500 border-cyan-500"
        ...
        <div className="flex flex-row">
          {params.id ? (
            ...
            <button
              ...
              className="btn btn-info text-white mt-4 ml-5 mb-3 basis-[95.7142857%]"
              onClick={() => {
                tugas ? handleCreate() : alert("Data harap di inputkan");
              }}
            >
              submit
            </button>
      ...
      <button className="btn btn-ghost ml-40" onClick={() => navigate("/")}>
